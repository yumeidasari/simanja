										...
										<div class="card sm-import-guide mb-0">
											<div class="card-header card-header-rose">
												<h4 class="card-title">
													...
													{{ __('Petunjuk Import Data Host Server') }}
												</h4>
											</div>
											<div class="card-body">
												...
												<ul class="sm-import-guide-list">
													<li><code>nama_alat</code></li>
													<li><code>tipe</code><span class="sm-import-guide-note">diisi dengan 'VM WARE' atau 'PROXMOX'</span></li>
													<li><code>model</code><span class="sm-import-guide-note">diisi dengan 'VM WARE' atau 'PROXMOX'</span></li>
													<li><code>nama_host</code></li>
													<li><code>ip_host</code></li>
													<li><code>os_host</code></li>
													<li><code>server_vm</code><span class="sm-import-guide-note">contoh: 10.10.10.3</span></li>
												</ul>
