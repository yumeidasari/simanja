										...
										<div class="card sm-import-guide mb-0">
											<div class="card-header card-header-rose">
												<h4 class="card-title">
													...
													{{ __('Petunjuk Import Data Perangkat Jaringan') }}
												</h4>
											</div>
											<div class="card-body">
												...
												<ul class="sm-import-guide-list">
													...
													<li><code>tipe</code><span class="sm-import-guide-note">tipe alat</span></li>
													<li><code>model</code><span class="sm-import-guide-note">model alat</span></li>
													<li><code>kode_alat</code></li>
													<li><code>kondisi</code><span class="sm-import-guide-note">diisi dengan 'BAIK' atau 'RUSAK'</span></li>
												</ul>
